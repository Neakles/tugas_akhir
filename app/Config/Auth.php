...
class Auth extends \Myth\Auth\Config\Auth
{
    ...
    // digunakan untuk halaman khussu tanpa login 
    public $controllerFilters = [
        'auth' => ['except' => ['login', 'logout', 'forgot_password', 'reset_password']], // tambahkan sesuai kebutuhan
        'tagihancontroller' => ['except' => ['autoAddTagihan']], // tambahkan sesuai kebutuhan
    ];
